...
Gtk.init(None)
q=Gtk.MessageDialog(None, Gtk.DialogFlags.MODAL, Gtk.MessageType.INFO, Gtk.ButtonsType.OK, "Update")
q.format_secondary_text("your os Has been updated Successfully.")
q.run()
