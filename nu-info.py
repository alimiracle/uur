...
Gtk.init(None)
q=Gtk.MessageDialog(None, Gtk.DialogFlags.MODAL, Gtk.MessageType.INFO, Gtk.ButtonsType.OK, "No Update")
q.format_secondary_text("There is no Update in this time.")
q.run()
